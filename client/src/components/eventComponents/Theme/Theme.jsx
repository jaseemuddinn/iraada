...
function Theme() {
    ...
    return (
        <div className='mt-10 px-10'>
            <h1 className='font-Montserrat font-bold text-7xl hover:italic'>
                Theme
            </h1>
            <p>
            ...
            <div className='grid grid-cols-2 flex-wrap gap-3 text-white mt-5 text-center font-Montserrat font-medium text-xl'>
                ...
                <div className='rounded-full p-8 bg-gray-500 hover:bg-gradient-to-bl from-green-400 via-teal-400 to-blue-500 hover:italic'>
                    Youth Celebrity Champions and Green Influencers
                </div>
                <div className='rounded-full p-8 bg-gray-500 hover:bg-gradient-to-bl from-green-400 via-teal-400 to-blue-500 hover:italic'>
                    Health
                </div>
